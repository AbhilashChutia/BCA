...
<body>
    ...
    <section class="newstudent">
        ...
        <div class="output">
            <h1>roll : <?php echo $row["roll"]; ?></h1>
        </div>
        <div class="output">
            <h1>Fundamentals of Computer : <?php echo $row["fundamentals_of_computer"]; ?></h1>
        </div>
        <div class="output">
            <h1>Programming in C : <?php echo $row["programming_in_c"]; ?></h1>
        </div>
        <div class="output">
            <h1>Database Management : <?php echo $row["databases_management"]; ?></h1>
        </div>
        <div class="output">
            <h1>Computer Graphics : <?php echo $row["computer_graphics"]; ?></h1>
        </div>
        <div class="output">
            <h1>Operations Research : <?php echo $row["operations_research"]; ?></h1>
        </div>
        <div class="output">
            <h1>Software Engineering : <?php echo $row["software_engineering"]; ?></h1>
        </div>
        <div>
