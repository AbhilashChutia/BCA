...
<body>
    ...
    <section class="login">
        ...
        <div class="row">
            <div class="teachers">
                <h2>for teachers</h2>
                <img src="images/teaachers.jpg" alt="">
                <a href="loginteacher.php" class="btn">Login</a>
            </div>
            <div class=" new">
                <h2>new students</h2>
                <img src="images/newstudents.jpg" alt="">
                <a href="loginnew.php" class="btn">Login</a>
            </div>
            <div class=" students">
                <h2>for students</h2>
                <img src="images/students.jpg" alt="">
                <a href="loginstudents.php" class="btn">Login</a>
            </div>
        </div>
        <h2>for any inconvinience, please contact the university.</h2>
    </section>
