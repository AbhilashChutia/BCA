...
if (isset($_POST['send'])) {
    ...
    $result = mysqli_query($connection, "SELECT * FROM admission WHERE username = '$username' && password = '$password'");
...
<body>
    ...
    <section class="login">
        ...
        <form name="formnewlogin" onsubmit=" return validateFormnew()" action="" method="post" class="">
            <div class="flex">
                <div class="inputBox">
                    <span>username :</span>
